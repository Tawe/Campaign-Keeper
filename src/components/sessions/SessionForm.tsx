...
import type { DmReflectionInput } from "@/app/actions/sessions";
...
import type { Npc, NpcDisposition, Visibility } from "@/types";
...
export function SessionForm({ campaignId, existingNpcs, existingPlayers = [], existingLocationNames = [], sessionId, initialValues }: SessionFormProps) {
